...
//template<class LZWBinFa>
ostream& operator<<(ostream& os,  vector<LZWBinFa>& v)
{
    //copy(v.begin(), v.end(), ostream_iterator<LZWBinFa>(os, " "));
    /*
    ...
    */
    ...
    for (vector<LZWBinFa>::iterator it = v.begin(); it != v.end(); it++)
        cout << *it;

    return os;
}
/*
ostream& operator<<(ostream& os, const vector<LZWBinFa>& v)
{
    LZWBinFa bf = v[0];
    fgv(bf);
    return os;
...
*/
    ...
    */
    ...
    std::cout << "\nPush_back előtt\n";
    v.push_back(binFa);
    std::cout << "Push_back után\n";
    /*
    std::cout << binFa3.getMelyseg() << endl;
    std::cout << binFa;
    std::cout << "BinFa3: \n";
    fgv(v[0]);
